    ...
    const renderSection = (section) => {
      ...
      switch (section?.type) {
          ...
          return (
            <section key={section.id} style={sectionStyle}>
              ...
              <div className="section-content">
                <h2 style={{ color: section.styles?.textColor }}>{section?.title}</h2>
                <p>{section?.content || ''}</p>
              </div>
            </section>
          );
        ...
        case 'about':
          return (
            <section key={section.id} style={sectionStyle}>
              ...
              <div className="section-content">
                <h2 style={{ color: section.styles?.textColor }}>
        ...
        case 'services':
          return (
            <section key={section.id} style={sectionStyle}>
              <h2 style={{ color: section.styles?.textColor,textAlign:'center'}}>
